...
class Employee < ActiveRecord::Base
  ...
  def archive_employee(status)
    ...
    employee_attributes.delete "reporting_out_time"
    employee_attributes.delete "reporting_in_time"
  ...
  def get_employee_in_time
    additional_field_id = AdditionalField.find_by_name("Reporting Time").try(:id)
    return employee_additional_details.find_by_additional_field_id(additional_field_id).additional_info rescue nil
  end
end
