...
RedactorPlugins.advanced = {
    ...
    insertFromLatexp: function (e) {
        exp = j("#redactor_modal .latex-expression").val(), data = "~~" + exp + "~~", this.selectionRestore(), this.execCommand("inserthtml", data), this.modalClose()
    }
}