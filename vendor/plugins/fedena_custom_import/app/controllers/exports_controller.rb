  ...
  def populate_associates
    render :update do |page|
      ...
      unless @model.blank?
        ...
        page.replace_html 'associates',:partial => 'associates' if @associated_models.present? or @join_models.present?
        page.replace_html 'associates','' unless @associated_models.present? or @join_models.present?
