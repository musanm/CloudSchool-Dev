...
module MultiSchool
  ...
  def self.multischool_settings
    @@multischool_settings = {"domain"=>"lvh.me", "tld_sizes"=>{"development"=>1, "production"=>1, "test"=>0}, "max_school_count"=>1,"organization_details"=>{"name"=>"Fedena","whitelabel"=>false,"school_stats"=>false},"email"=>"info@foradian.com","contact_num"=>"9123123456"}
