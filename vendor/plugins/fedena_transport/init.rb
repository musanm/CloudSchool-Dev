...
FedenaPlugin.register = {
  ...
  :multischool_models=>%w{Route Transport TransportFee TransportFeeCollection Vehicle RouteVehicleAdditionalField RouteAdditionalFieldOption RouteVehicleAdditionalDetail VehicleAdditionalFieldOption}
}
