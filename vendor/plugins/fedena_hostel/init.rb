...
FedenaPlugin.register = {
  ...
  :multischool_models=>%w{Hostel HostelFee HostelFeeCollection RoomAllocation RoomDetail Warden HostelRoomAdditionalField RoomAdditionalFieldOption HostelAdditionalFieldOption HostelRoomAdditionalDetail}
}
